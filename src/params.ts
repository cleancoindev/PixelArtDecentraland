...
export const wallBlocksX2: number = 18;
export const wallBlocksY: number = 13;
export const wallBlocksY2: number = 8;
export const wallWidth = 16;
export const wallHeight = 8;
export const wallOffsetX = 0.75;
export const wallOffsetY = 0.75;
...
export const apiUrl = "https://leaderboard.stayl.it"
